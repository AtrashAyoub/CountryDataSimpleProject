...
def Task(country):
    ...
    if response.status_code != 200:
        ...
        print("Something gone wrong, check country name and try again!")
    else:
        res = '<h1>Welcome to Ayoub app</h1>'
        data = (response.json())
        Data_dic = data[0]
        #print("Country’s Full Name: ",Data_dic['name'])
        res+="<b>Country’s Full Name: "+Data_dic['name']+'<br/>'
        #print("Country’s Capital: ",Data_dic['capital'])
        res+="Country’s Capital: "+Data_dic['capital']+'<br/>'
        #print("Country’s Common Language: ", Data_dic["languages"][0]["name"])
        res+="Country’s Common Language: "+Data_dic["languages"][0]["name"]+'<br/>'
        #print("Country’s Currency Name: ", Data_dic['currencies'][0]["name"])
        ...
        #print("Country’s Currency rate: ", curr_data["rates"][Curr_code])
